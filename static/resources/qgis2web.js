...
map.getView().fit([-8019214.743961, -1522632.566191, -8008445.410083, -1517095.268678], map.getSize());
...
var onSingleClick = function(evt) {
            ...
            if (url) {
              ...
              fetch(url)
                ...
                .then((html) => {
                  ...
                  var info_zona = JSON.parse(html);
                  console.log("loti: ", info_zona.features);
                  ...
                  if (info_zona.features[0]) {
                    infoGeneral.push({
                      layer: info_zona.features[0].id,
                      properties: info_zona.features[0].properties,
                    });
                    this.viewPopup = true;
                  }
    ...
    if (popupText) {
        ...
        document.getElementById("demo").innerHTML = infoGeneral[0].layer;
    } else {
        container.style.display = 'none';
        closer.blur();
    }
